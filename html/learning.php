...
<section class="health-plan">
     <div class="container">
          <div class="row align-items-center">
               ...
               <div class="col-lg-6">
                    <div class="feature-plan">
                         <img src="images/enrollment.png" class="img-fluid" alt="">
                    </div>
               </div>
          </div>
     </div>
...
<section class="inner-faq-sec zag-faq">
     <div class="container">
          <div class="row align-items-center">
               ...
               <div class="col-lg-6">
                    <div class="feature-plan">
                         <img src="images/aca.png" class="img-fluid" alt="">
                    </div>
               </div>
          </div>
          <div class="row align-items-center flex-row-reverse">
               ...
               <div class="col-lg-6">
                    <div class="feature-plan">
                         <img src="images/hmo.png" class="img-fluid" alt="">
                    </div>
               </div>
          </div>
          <div class="row align-items-center">
               ...
               <div class="col-lg-6">
                    <div class="feature-plan">
                         <img src="images/epo.png" class="img-fluid" alt="">
                    </div>
               </div>
          </div>
          <div class="row align-items-center flex-row-reverse">
               ...
               <div class="col-lg-6">
                    <div class="feature-plan">
                         <img src="images/pos.png" class="img-fluid" alt="">
                    </div>
               </div>
          </div>
          <div class="row align-items-center">
               ...
               <div class="col-lg-6">
                    <div class="feature-plan">
                         <img src="images/hso.png" class="img-fluid" alt="">
                    </div>
               </div>
          </div>
     </div>
