@php
     $page = \Illuminate\Support\Facades\DB::table('pages')->where('id', 4)->first();
     $sections = \Illuminate\Support\Facades\DB::table('section')->where('page_id', 4)->get();
@endphp
...
@section('content')
     <section class="inner-banner vision-banner" style="background-image: url({{asset($page->image)}})!important;">
          <div class="container">
               <div class="row">
                    <div class="col-lg-12">
                    ...
                    <div class="col-lg-3">
                         <div class="main-collaps">
                              <ul class="nav nav-tabs" role="tablist">
                                   ...
                                   <li class="nav-item">
                                        <a class="nav-link active" data-toggle="tab" href="#tabs-2" role="tab">Vision
                                             Insurance</a>
                                   </li>
                                   <li class="nav-item">
...
{{--                                                  </div>--}}
                                             ...
                                             <div class="financial-assistance">
                                                  <div class="financial-name">
                                                       <img src="{{asset($sections[11]->value)}}" class="img-fluid" alt="">
{{--                                                       <h4>Prevention</h4>--}}
                                                       {!! $sections[9]->value !!}
                                                  </div>
{{--                                                  <div class="financial-discription">--}}
...
{{--                                                  </div>--}}
                                             ...
                                             <div class="financial-assistance">
                                                  <div class="financial-name">
                                                       <img src="{{asset($sections[17]->value)}}" class="img-fluid" alt="">
