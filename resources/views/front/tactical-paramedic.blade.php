@extends('layouts.app')
@section('title', 'Tactical Paramedic IBSC Online Approved Review Course')
            ...
            <div class="row align-items-end pb-5">
                <div class="col-lg-8">
                    <div class="tactical-paramedic-text">
                        ...
                        <h5>Tactical Paramedic IBSC Online Approved Review Course</h5>
                ...
                <div class="col-lg-8">
                    <div class="tactical-paramedic-section-main">
                        <div class="tactical-paramedic-section-main-img">
                            <img src="{{asset('images/tactical-paramedic-img-1.webp')}}" alt="" class="img-fluid">
                        </div>
                            ...
                            <div class="tab-content" id="pills-tabContent">
                                ...
                                <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                                    <div class="tactical-paramedic-tab-text">
                                        ...
                                        <h5>TP-C Recertification</h5>
                                        <p>Recertification options for the Certified Tactical Paramedic (TP-C) credential include the following:</p>
                                        <ul>
                                        ...
                                        <ul>
                                            <li>Maintain current TP-C certification</li>
                                            <li>Maintain current, unrestricted paramedic license in the state or country of practice</li>
                                            <ul class="list-change-1">
                                                <li class="py">Any restriction(s) must be reported to the IBSC</li>
                                                <ul class="list-change-2">
                                                    <li>Complete and submit 100 approved continuing education (CE) credits</li>
                                                    ...
                                                    <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
                                                        <div class="card-body">
                                                            <div class="tactical-paramedic-tab-text-according-text">
                                                                <ul>
                                                                    <li><span><i class="fa-solid fa-file"></i> TAM-P Introduction to Tactial & Austere Medicine</span><span><i class="fa-solid fa-lock"></i></span></li>
                                                        ...
                                                        <div class="card-body">
                                                            <div class="tactical-paramedic-tab-text-according-text">
                                                                ...
                                                                TAM-P Types of Operational Tactical Callouts</span><span><i class="fa-solid fa-lock"></i></span></li>
                                                                    ...
                                                                    <li><span><i class="fa-solid fa-file"></i> TAM-P Operations Tactics with Conventional Threats and Weapons Commonly Improvised</span><span><i class="fa-solid fa-lock"></i></span></li>
                    ...
                    <div class="tactical-paramedic-section-main-2">
                        ...
                        <div class="tactical-paramedic-section-main-2-box p-0">
                            <div class="tactical-paramedic-section-main-2-box-1">
                                <h5>$350.00</h5>
                                <a href="https://roryemtp.ispring.com/view/90916141-GqRhn-Dh6hJ-cuFmc" class="box-anker">Add to cart</a>
                            </div>
