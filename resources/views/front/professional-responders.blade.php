@extends('layouts.app')
@section('title', 'Professional Responders')
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="staff-info about-course-inof">
                        ...
                        <p>This course is offered in a TAM-P Urban course for the EMTs and Paramedics and a GAMS First Responder (GFR) course for Law Enforcement.</p>
                        <h4>Combination eLearning model TAM-P Urban:</h4>
