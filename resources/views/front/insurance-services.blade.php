...
{{--                         </div>--}}
     ...
     <section class="inner-faq-sec">
          <div class="container">
               <div class="row">
                    <div class="col-lg-12">
                         <div class="enrollment">
                              <h2 class="side-heading aos-init" aos-init="" aos-animate="" data-aos="fade-down"
                              data-aos-offset="300" data-aos-easing="ease-in-sine" data-aos-duration="1000">What kinds
                              of insurance plans will you find available with ACA?</h2>
                         </div>
                         <div class="inner-faq">
                              <div class="accordion" id="accordionExample">
                                   <div class="card" data-aos="fade-down" data-aos-duration="2000">
                                        <div class="card-header" id="headingOne">
                                             <h2 class="mb-0">
                                                  <button class="btn btn-link btn-block text-left" type="button"
                                                       ...
                                                       What kinds of insurance plans will you find available with ACA?
                                                       <span class="collapsss plus-collaps"><i
                                                                    class="fa-solid fa-plus"></i></span>
                                                       <span class="collapsss minus-collaps"><i
                                        ...
                                        <div id="collapseOne" class="collapse show" aria-labelledby="headingOne"
                                             ...
                                             <div class="card-body">
                                                  Lorem ipsum dolor sit amet consectetur adipisicing elit. Quos iste, sed
                                                  quasi et, harum debitis provident officiis esse alias, sunt veniam quidem
                                                  quod pariatur! Et vitae dolor eius illo vero?
                                             </div>
                                        </div>
                                   </div>
                                   <div class="card" data-aos="fade-down" data-aos-duration="2000">
                                        ...
                                        <div class="card-header" id="headingsix">
                                             <h2 class="mb-0">
                                                  <button class="btn btn-link btn-block text-left collapsed" type="button"
                                                       ...
                                                       Is there a good selection of Trusted, Quality Insurance Carriers
                                        ...
                                        <div class="card-header" id="headingseven">
                                             <h2 class="mb-0">
                                                  <button class="btn btn-link btn-block text-left collapsed" type="button"
                                                       ...
                                                       What is the significance of the health plan ‘metal’ categories of
                                                       Bronze, Silver, Gold, and Platinum when choosing a plan?
                                                       <span class="collapsss plus-collaps"><i
                                                                    class="fa-solid fa-plus"></i></span>
                                                       <span class="collapsss minus-collaps"><i
                                                                    class="fa-solid fa-minus"></i></span>
                                        ...
                                        <div class="card-header" id="headingeight">
                                             <h2 class="mb-0">
                                                  <button class="btn btn-link btn-block text-left collapsed" type="button"
                                                       ...
                                                       What is the Open Enrollment Period (OEP) in the ACA Health Insurance
                                                       Marketplace?
                                                       <span class="collapsss plus-collaps"><i
                                                                    class="fa-solid fa-plus"></i></span>
                                                       <span class="collapsss minus-collaps"><i
                                        ...
                                        <div class="card-header" id="headingnine">
                                             <h2 class="mb-0">
                                                  <button class="btn btn-link btn-block text-left collapsed" type="button"
                                                       ...
                                                       Will my ACA health insurance plan auto-renew?
                                                       <span class="collapsss plus-collaps"><i
                                                                    class="fa-solid fa-plus"></i></span>
                                                       <span class="collapsss minus-collaps"><i
                                                                    class="fa-solid fa-minus"></i></span>
                                        ...
                                        <div class="card-header" id="headingten">
                                             <h2 class="mb-0">
                                                  <button class="btn btn-link btn-block text-left collapsed" type="button"
                                                       ...
                                                       What is a Special Enrollment Period (SEP) in the Marketplace for ACA
                                                       health plans?
                                                       <span class="collapsss plus-collaps"><i
                                                                    class="fa-solid fa-plus"></i></span>
                                                       <span class="collapsss minus-collaps"><i
                                        ...
                                        <div class="card-header" id="headingten">
                                             <h2 class="mb-0">
                                                  <button class="btn btn-link btn-block text-left collapsed" type="button"
                                                          data-toggle="collapse" data-target="#collapseten"
                                                          aria-expanded="false" aria-controls="collapseten">
                                                       Do I have to enroll in health insurance through the Health Insurance
                                                       Marketplace?
                                                       <span class="collapsss plus-collaps"><i
                                                                    class="fa-solid fa-plus"></i></span>
                                                       <span class="collapsss minus-collaps"><i
                                        ...
                                        <div class="card-header" id="headingeleven">
                                             <h2 class="mb-0">
                                                  <button class="btn btn-link btn-block text-left collapsed" type="button"
                                                       ...
                                                       Can ACA subsidies lower my monthly premium for health insurance?
                                                       <span class="collapsss plus-collaps"><i
                                                                    class="fa-solid fa-plus"></i></span>
                                                       <span class="collapsss minus-collaps"><i
                                                                    class="fa-solid fa-minus"></i></span>
                                        ...
                                        <div class="card-header" id="headingthirteen">
                                             <h2 class="mb-0">
                                                  <button class="btn btn-link btn-block text-left collapsed" type="button"
                                                       ...
                                                       Does enrollment in a beneficial ACA Health Insurance Plan involve cash
                                                       cards in any way and what does this have to do with a subsidy?
                                                       <span class="collapsss plus-collaps"><i
                                                                    class="fa-solid fa-plus"></i></span>
                                                       <span class="collapsss minus-collaps"><i
                                                                    class="fa-solid fa-minus"></i></span>
                                        ...
                                        <div class="card-header" id="headingfourteen">
                                             <h2 class="mb-0">
                                                  <button class="btn btn-link btn-block text-left collapsed" type="button"
                                                       ...
                                                       How can Engage Health Insurance LLC Help?
                                                       <span class="collapsss plus-collaps"><i
                                                                    class="fa-solid fa-plus"></i></span>
                                                       <span class="collapsss minus-collaps"><i
                                                                    class="fa-solid fa-minus"></i></span>
