@php
    $page = \Illuminate\Support\Facades\DB::table('pages')->where('id', 20)->first();
    $sections = \Illuminate\Support\Facades\DB::table('section')->where('page_id', 20)->get();
@endphp


@extends('layouts.app')
@section('title', 'GAMS Tactical Austere Medical Practitioner (TAM-P) Austere Care')
...
{{--                        <h5>GAMS Tactical Austere Medical Practitioner (TAM-P) Austere Care</h5>--}}
                        {!! $page->content !!}
                        <p>Uncategorized
                ...
                <div class="col-lg-8">
                    <div class="tactical-paramedic-section-main">
                        <div class="tactical-paramedic-section-main-img">
                            <img src="{{asset('images/tactical-austere-care-img-1.jpg')}}" alt="" class="img-fluid">
                        </div>
...
{{--                                        <p>For agencies interested in learning more about this vital training program, please reach out to Goat-Trail Austere Medical Solutions (GAMS) to explore its significance and its impact on operational preparedness.</p>--}}
...
{{--                                            <li>In-Class TECC – <strong>63 hours</strong></li>--}}
...
{{--                                        </ul>--}}
{{--                                        <h6>Eligibility Criteria for TAM-P Course Austere – Providers minimum number is 20, max 50.</h6>--}}
...
{{--                                                                    <li><span><i class="fa-regular fa-circle-question"></i>--}}
{{--                                                                    TAM-P Field Care MARCH Respirations</span><span><i--}}
{{--                                                                                    class="fa-solid fa-lock"></i></span>--}}
{{--                                                                    </li>--}}
...
{{--                                                                    </li>--}}
{{--                                                                    <li><span><i class="fa-solid fa-file"></i>--}}
{{--                                                                    Advanced Cardiology</span><span><i--}}
{{--                                                                                    class="fa-solid fa-lock"></i>--}}
{{--                                                                    </span>--}}
{{--                                                                    </li>--}}
                    ...
                    <div class="tactical-paramedic-section-main-2">
                        ...
                        <div class="tactical-paramedic-section-main-2-box p-0">
                            <div class="tactical-paramedic-section-main-2-box-1">
                                <h5>2000.00</h5>
                                <a href="https://roryemtp.ispring.com/view/90916141-WLAh9-Vh4sw-1YZpG" class="box-anker">Add to cart</a>
                            </div>
                            <ul class="tactical-paramedic-section-main-2-box-2">
                                <li><i class="fa-regular fa-clock"></i> Intermediate</li>
                                <li><i class="fa-regular fa-clock"></i> 0 Total Enrolled</li>
                                <li><i class="fa-regular fa-clock"></i> 93 hours Duration</li>
