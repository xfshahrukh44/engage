                        ...
                        <div class="row align-items-center">
                            <div class="col-lg-6">
                                <div class="contact-form">
                                    ...
                                    <p class="para-1">One of our licensed agents can help review your health insurance
                                        needs
                        ...
                        <div id="accordion" class="accordionStyle">
                            <div class="card">
                                <div class="card-header" id="headingOne">
                                    <button class="btn btn-link" data-toggle="collapse" data-target="#collapseOne"
                                        aria-expanded="true" aria-controls="collapseOne">Can I purchase health insurance
                                        on
                                ...
                                <div id="collapseOne" class="collapse show" aria-labelledby="headingFive"
                                    ...
                                    <div class="card-body">
                                        <p class="para-1">Yes! Although <a
                                                href="{{ route('front.health-insurance') }}">Engage
                                                Health
                                                Insurance
                                                LLC</a> provides
                                            unbiased advice
                            ...
                            <div class="card">
                                ...
                                <div id="collapseTwelve1" class="collapse" aria-labelledby="headingFive"
                                    data-parent="#accordion">
                                    <div class="card-body">
                                        <p class="para-1">Absolutely! Just enter demographic basics like Zip Code,
                                            Birthdate
                            ...
                            <div class="card">
                                ...
                                <div id="collapseTwelve3" class="collapse" aria-labelledby="headingfive"
                                    data-parent="#accordion">
                                    <div class="card-body">
                                        <p class="para-1">ACA subsidies can eliminate or lower the cost of monthly
                                            premiums!
                                            This is a
